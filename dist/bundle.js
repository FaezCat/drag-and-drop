...
define("components/project-list", ["require", "exports", "models/project", "components/base-component", "decorators/autobind", "state/project-state", "components/project-item"], function (require, exports, project_js_2, base_component_js_3, autobind_js_3, project_state_js_2, project_item_1) {
    ...
    class ProjectList extends base_component_js_3.Component {
        ...
        dropHandler(event) {
            ...
            project_state_js_2.projectState.moveProject(projId, this.type === 'active' ? project_js_2.ProjectStatus.Active : project_js_2.ProjectStatus.Completed);
        }
        dragLeaveHandler(_) {
            const listEl = this.element.querySelector('ul');
        ...
        configure() {
            ...
            project_state_js_2.projectState.addListener((projects) => {
                const relevantProjects = projects.filter((proj) => {
                    ...
                    return proj.status === project_js_2.ProjectStatus.Completed;
                });
        ...
        renderProjects() {
            ...
            for (const projItem of this.assignedProjects) {
                new project_item_1.ProjectItem(this.element.querySelector('ul').id, projItem);
            }
        }
    }
    __decorate([
